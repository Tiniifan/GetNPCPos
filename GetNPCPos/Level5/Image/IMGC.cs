...
using GetNPCPos.Level5.Compression;
using GetNPCPos.Level5.Compression.ETC1;
using GetNPCPos.Level5.Image.Color_Formats;

namespace GetNPCPos.Level5.Image
{
    public static class IMGC
    {
        public static (Bitmap, int, int) ToBitmap(byte[] fileContent)
        {
            ...
            return (DecodeImage(tileData, imageData, IMGCSupport.ImageFormats[header.ImageFormat], header.Width, header.Height, header.BitDepth), header.Width, header.Height);
        }

...
using GetNPCPos.Level5.Compression.NoCompression;
using GetNPCPos.Level5.Compression.Zlib;
using GetNPCPos.Level5.Compression.LZ10;

namespace GetNPCPos.Level5.Archive.XPCK
{
